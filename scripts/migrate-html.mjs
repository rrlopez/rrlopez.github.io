...
const pages = [
  { html: 'index.html', astro: 'src/pages/index.astro', fragment: 'src/content/index.html', layout: 'HomeLayout' },
  { html: 'nuvelco-cca.html', astro: 'src/pages/nuvelco-cca.html.astro', fragment: 'src/content/nuvelco-cca.html', layout: 'ProjectLayout' },
  { html: 'start-pos.html', astro: 'src/pages/start-pos.html.astro', fragment: 'src/content/start-pos.html', layout: 'ProjectLayout' },
  { html: 'overlay-manager.html', astro: 'src/pages/overlay-manager.html.astro', fragment: 'src/content/overlay-manager.html', layout: 'OverlayLayout' },
  { html: 'blog/offline-app-shell.html', astro: 'src/pages/blog/offline-app-shell.html.astro', fragment: 'src/content/blog/offline-app-shell.html', layout: 'BlogLayout' },
  { html: 'blog/offline-auth-engine.html', astro: 'src/pages/blog/offline-auth-engine.html.astro', fragment: 'src/content/blog/offline-auth-engine.html', layout: 'BlogLayout' },
  { html: 'blog/making-db-closer-to-app.html', astro: 'src/pages/blog/making-db-closer-to-app.html.astro', fragment: 'src/content/blog/making-db-closer-to-app.html', layout: 'BlogLayout' },
  { html: 'blog/overlay-manager-deep-dive.html', astro: 'src/pages/blog/overlay-manager-deep-dive.html.astro', fragment: 'src/content/blog/overlay-manager-deep-dive.html', layout: 'BlogLayout' },
];
...
function inlineScripts(body) {
  return body.replace(/<script(?![^>]*\bis:inline\b)(?![^>]*\bsrc=)/g, '<script is:inline');
}
